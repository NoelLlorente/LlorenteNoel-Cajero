...
public class JDMarcoAdmCuentas extends JDialog{
	...
	private JDCrearCuenta crearCuenta;
	private JDMarcoAdmMovimientosCuenta admMovi;
	public JDMarcoAdmCuentas(MarcoUsuarioAdministrador marcoAdm) {
		this.setTitle("Gestion Cuentas");
		this.marcoAdm = marcoAdm;
		crearCuenta = new JDCrearCuenta(this);
		admMovi = new JDMarcoAdmMovimientosCuenta(this);
		JPanel jp1 = new JPanel();
		JPanel jp2 = new JPanel();
		JPanel jp3 = new JPanel();
		jp1.setBorder(new TitledBorder("Buscar Por:"));
		
		String[] titu = {"Id", "Nombre", "Saldo", "Id Tarjeta"};
		String[] txtcombo = {"Mostrar Todos","Id", "Nombre", "Saldo", "Id Tarjeta"};
		...
		String[] op = {"Nuevo", "Modificar", "Eliminar", "Movimientos", "Salir"};
	...
	public JDCrearCuenta getCrearCuenta() {
		return crearCuenta;
	}


	public void setCrearCuenta(JDCrearCuenta crearCuenta) {
		this.crearCuenta = crearCuenta;
	}


	public JDMarcoAdmMovimientosCuenta getAdmMovi() {
		return admMovi;
	}


	public void setAdmMovi(JDMarcoAdmMovimientosCuenta admMovi) {
		this.admMovi = admMovi;
	}
